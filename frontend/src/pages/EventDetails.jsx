        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            {isRegistered ? (
              <button
                disabled
                className="px-8 py-4 rounded-xl bg-green-600 cursor-not-allowed flex items-center gap-2"
              >
                ✓ Registered
              </button>
            ) : (
              <button
                ...
                className="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 flex items-center gap-2 hover:scale-[1.02] transition"
              >
                Register Now
                <FaArrowRight />
              </button>
            ...
            <button
              ...
              className="px-8 py-4 rounded-xl border border-slate-700 hover:border-blue-500 transition"
            >
              Download Brochure
            </button>
